...
async def list_clients(
    ...
    clients, total = await client_service.get_clients(db, current_user.id, page, size, search, active_only, is_active, sort_by=sort_by or "created_at", sort_order=sort_order or "desc")

...
async def list_reminders(
    ...
    reminders, total = await reminder_service.get_reminders(db, current_user.id, page, size, status, search, sort_by=sort_by or "remind_date", sort_order=sort_order or "asc")
